    ...
    <main class="main-content">
      <header class="top-header">
        <div class="breadcrumb">
          ...
          <span class="text-bold">{{ activeTab === 'games' ? '游戏列表' : '游客反馈' }}</span>
        </div>

        <div class="header-actions" v-if="activeTab === 'games'">
...
// 🌟 当前选择的侧边栏 Tab 标签 ('games' | 'feedback')
...
.action-btn { background: none; border: none; cursor: pointer; color: var(--text-muted, #64748B); transition: color 0.2s; display: flex; align-items: center; gap: 6px; }
